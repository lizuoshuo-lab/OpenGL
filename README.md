...
- 使用 AABB Frustum Culling、GPU Instancing 和三级 Mesh LOD 优化 5000 颗多材质小行星；Debug 1600 x 900 实测 Draw Call 从 10232 降至 27。
...
- 自动 A/B 基准通过，测试结束后进程可自行关闭；CPU `381.355 -> 23.594 ms`、GPU `179.607 -> 0.628 ms`、Draw Call `10232 -> 27`、三角形 `49.026M -> 4.170M`。
